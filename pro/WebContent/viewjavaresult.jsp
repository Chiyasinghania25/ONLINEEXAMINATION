...
<body background="im.jpg">
	<a href="choice.jsp"><input type="button" value="Home" style="color:black;background:white;padding-top:15px;padding-right:15px;padding-bottom:15px;padding-left:5px;border-radius:4px;border:none;border-bottom:4px solid #27aE60;cursor:pointer;height:40px;width:100px;margin-right:30px; "></a>
    <h1 style="color:white;text-align:center;">DETAILED RESULT: </h1>
    <br>
